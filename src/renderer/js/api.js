...
const api = {
  ...
  applyGroup: (skinName, groupId, presetIds, ownActionsOnly) => window.tauriAPI.applyGroup(skinName, groupId, presetIds, ownActionsOnly),
  ...
  setSkinMeta: (skinName, accentHue, text1, text2, link) => window.tauriAPI.setSkinMeta(skinName, accentHue, text1, text2, link),
