...
const INI_FIELD_DEFS = (() => {
  // Section order follows the osu! wiki (General, Fonts, Colours,
  // CatchTheBeat, Mania). Key order within each section is preserved as-is.
  return [
    // ── General ──
    ...
    { section: 'Mania', key: 'StageLight', type: 'path' },
